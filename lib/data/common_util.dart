import 'package:flutter_app_getx/data/constants.dart';
import 'package:intl/intl.dart';

class CommonUtil {
  String sendPhoneWithCountryCode(String phone) {
    if (phone.startsWith("0") == true) {
      return defaultCountryCode + phone.substring(1);
    } else if (phone.startsWith("+840") == true) {
      return defaultCountryCode + phone.substring(4);
  ...
  String formatFullTimeString(String time) {
    DateTime dateTime = DateTime.parse(time);
    return DateFormat("HH:mm dd/MM/yyyy").format(dateTime);
  }

  String formatDateTimeFromString(String time) {
    DateTime dateTime = DateTime.parse(time);
    return DateFormat("dd/MM/yyyy").format(dateTime);
  }

  String formatDateTimefromDate(DateTime time) {
